...
@interface NapSleepTimeDrawView : UIView
...
-(void)startDraw:(NSMutableArray<DBSleepData *> * ) sleepObjArray SleepStart:(NSNumber *)  startSleepTimeInterval  SleepEnd:(NSNumber *)endSleepTimeInterval;
